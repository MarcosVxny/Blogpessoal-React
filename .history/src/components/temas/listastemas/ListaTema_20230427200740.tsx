...
function ListaTema() {
    ...
    const [token, setToken] = useLocalStorage('token'); // Ele ta pegando as variaveis e enviando ela ao useLocalStorage que é aonde eu vou guardar o dado que eu quero, por exemplo  
